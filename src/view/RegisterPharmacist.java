...
public class RegisterPharmacist {
    
    private Employee admin;
    public RegisterPharmacist (Employee admin){
        this.admin = admin;
    }
...
//                
		...
		st.setScene(sc);
		st.setTitle("Register New Pharmacist");
				...
				if(userField.getText()!=null && passField.getText()!=null
						...
						email.getText()!= null && phone.getText()!= null && salary.getText()!=null){
                                    ...
                                    UserRW user=new UserRW();
                                        user.addEmp(new model.base.Pharmacist(userField.getText(), passField.getText(),
